...
{
    public class PedidoEmprestimoViewModel
    {
        public PedidoEmprestimoViewModel(int codigoPedido, int codigoObra, int idUsuarioG, string statusEmprestimo, DateTime dataHora, bool prioridade)
        {
